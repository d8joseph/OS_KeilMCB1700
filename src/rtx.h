...
extern int k_get_pid(void);
#define get_pid() _get_pid((U32)k_get_pid)
extern int __SVC_0 _get_pid(U32 p_func);
...
extern void __SVC_0 *_get_process_priority(U32 p_func, int pid);
